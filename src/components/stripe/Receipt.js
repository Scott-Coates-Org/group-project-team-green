...
const Email = () => {
        ...
        data: [
          {
            ...
            receipt_number: null,
            receipt_url:
              "https://pay.stripe.com/receipts/acct_1JJJ08Pe3Sdo1GEV/ch_3LK4AtPe3Sdo1GEV02WzXGvV/rcpt_M28T1PXWoNzD5PBghhCWWvwGjwfqdbX",
          },
        ],
      },
    },
  ...
  useEffect(() => {
    setReceiptURL(eventData.object.charges.data[0].receipt_url)
    setCustomerEmail(eventData.object.charges.data[0].receipt_email)
  })

  const handleEventData = async () => {
    console.log(
      "Thanks for your payment! You can view your reciept here:",
      receiptURL
    )
  }
