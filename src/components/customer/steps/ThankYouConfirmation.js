    ...
    <div className="thank-you-container">
      <div className="thank-you-wrapper">
        <div className="d-flex flex-column justify-content-center align-items-center mt-5">
          ...
          <h3>
            Your order <b>#111111</b> has been placed!
          </h3>
          <h6>
            We sent an email to <b>[email]</b> with your order confirmation and
            receipt.{" "}
          </h6>
          ...
          <div>
            <Card>
              <CardBody className="order-item-card">
                ...
                <div className="item-description">
                  <CardTitle tag="h5">Junior Jumper 6 or Under Pass</CardTitle>
            ...
            <Card>
              <CardBody className="order-item-card">
                ...
                <div className="item-description">
                  <CardTitle tag="h5">Junior Jumper Parent Pass</CardTitle>
                  <CardSubtitle className="mb-2 text-muted" tag="h6">
                    <p>quantity: 2</p>
                    <p>time: 10:00 AM</p>
                    <p>duration: 2 hours</p>
